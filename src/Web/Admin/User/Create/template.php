...
$htmlForm = Html::form()
    ->post($urlGenerator->generate('admin/user/create'))
    ->csrf($csrf);
...
<div class="px-4 py-12">
    <div class="mx-auto w-full max-w-2xl">
        <div class="mb-8">
            <h1 class="text-2xl font-semibold tracking-tight text-gray-900">Create User</h1>
            <p class="mt-2 text-sm text-gray-500">Add a new user</p>
        </div>
